<nav class="pagination">
	<?php if (isset($page) === true && is_numeric($page) && $page >= 2): ?>
		<a href="?<?= http_build_query(array_merge( $_GET, array( 'page' => (isset($page) === true && is_numeric($page) ?  ($page - 1) : 1)))); ?>">Precedent</a>
	<?php endif;?>
	<?php
	...
	<?php if (isset($page) === true && is_numeric($page) && $page < $totalPage): ?>
		<a href="?<?= http_build_query(array_merge( $_GET, array( 'page' => (isset($page) === true && is_numeric($page) ?  ($page + 1) : 2)))); ?>">Suivant</a>
	<?php endif;?>
</nav>
