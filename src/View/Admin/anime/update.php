...
<!-- 			<label for="genres">Genres :
				<input class="padding-xs full-width" type="text" name="genres" id="genres" placeholder="comma-separator; e.g : Action, Mecha, Sci-Fi, Seinen" value="<?= implode(", ", $metas["genre"]) ?>">
			</label>
			<label for="producers">Producers :
				<input class="padding-xs full-width" type="text" name="producers" id="producers" placeholder="comma-separator" value="<?= implode(", ", $metas["producer"]) ?>">
			</label>
			<label for="studios">Studios :
				<input class="padding-xs full-width" type="text" name="studios" id="studios" placeholder="comma-separator" value="<?= implode(", ", $metas["studio"]) ?>">
			</label>
			<label for="synonyms">Synonyms :
				<input class="padding-xs full-width" type="text" name="synonyms" id="synonyms" placeholder="comma-separator" value="<?= implode(", ", $metas["synonym"]) ?>">
			</label>	 -->
		</div>
	<div class="margin-top">
			<button class="padding-xs" name="update">Update</button>
	</div>
	</form>
</div>
