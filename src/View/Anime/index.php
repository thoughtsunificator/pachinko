<div id="anime-index" class="wrap">
	...
	<div class="display-grid template-2colauto1fr grid-column-gap-xxl">
		<div class="display-grid grid-auto-rows-maxcontent">
			...
			?>
			<img src="<?= htmlspecialchars($image) ?>" onerror="this.onerror=null; this.src='/resource/image/anime/default.png'"  alt="Anime cover">
			...
			<div class="margin-bottom padding-xs background-color-zambezi">
				<div class="display-grid grid-gap">
					...
					<a href="?id=<?= $anime->getField('id_anime') ?>&action=remove_review&id_historique=<?= $review["id_historique"] ?>">Supprimer</a>
						...
						<div>
							<img onerror="this.onerror=null; this.src='/resource/image/anime/default.png'" width="60" src="<?= htmlspecialchars($review['avatar']) !== null ? ("./resource/image/avatar/". $review["avatar"]) : ("https://api.adorable.io/avatars/70/". urlencode(htmlspecialchars($review['fiche_personne_nom'])) . "@adorable.png") ?>" alt="Avatar">
						</div>
					</div>
